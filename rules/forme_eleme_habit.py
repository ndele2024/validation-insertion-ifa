"""
Règles métier : Forme de l'élément d'habitat (FORME_ELEME_HABIT)
Règle couverte :
...
LAYER = "forme_eleme_habit"

NOMBRE_MAX_ENREGISTREMENTS = 15


@register(LAYER, kind=RuleKind.LAYER)
def forme_eleme_habit_nombre_max(ctx: RuleContext) -> list[ValidationIssue]:
    ...
    return [ValidationIssue(
        layer=ctx.layer, severity=Severity.ERROR, code="FORME_ELEME_HABIT_NOMBRE_MAX_ENREGISTREMENTS",
        message=(
